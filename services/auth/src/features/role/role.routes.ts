...
import { addRole, getRole, getRoles, updateRole, deleteRole, getPermissions } from "./role.controller";
...
router.get('/get-permissions',  requirePermissions(["Permission.read"]),getPermissions,actionLogger("get permissions"));
